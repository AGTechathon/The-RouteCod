...
const ServiceSection = () => {
  ...
  const expandedDescriptions = [
    // Description for "Generate Itinerary with AI"
    ...
    // Description for "Generate Itinerary from Scratch"
    <ul className="list-disc pl-5 text-sm text-gray-200">
      <li>Blank Canvas Creation: Start from scratch by adding custom blocks to shape your own unique travel plan.</li>
      <li>Drag & Drop Interface: Effortlessly add elements like hotels, attractions, or restaurants into your itinerary.</li>
      <li>Manual or Assisted Input: Fill blocks with personal details or choose structured forms for activity data.</li>
      <li>Media Support: Upload images and write descriptions to enrich your travel plans visually and informatively.</li>
      <li>Modular Editing: Resize, remove, or reorder blocks at any time for total flexibility in planning.</li>
      <li>Custom Categories: Classify each entry by activity type — adventure, cultural, food, etc., for easy sorting.</li>
    </ul>
  ];
                    ...
                    >
                      <div className="bg-grey-200 rounded-3xl shadow-2xl max-w-5xl w-full flex overflow-hidden backdrop-blur-md">
                        ...
                        <div className="w-full p-8 flex flex-col justify-center">
                          <h1 className="text-3xl font-bold mb-4 text-gray-200">{service.title}</h1>
                          <div>{expandedDescriptions[index]}</div>
                          <button
